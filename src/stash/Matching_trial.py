...
# Save matches
matches_df.to_csv(r'../outputs/matched_triads_n2.csv', index=False)
print("Matches saved to ../outputs/matched_triads_n2.csv")
...
identified_df.to_csv(r'../outputs/identified_stars_n2.csv', index=False)
print(r"Identified stars saved to ../outputs/identified_stars_n2.csv")