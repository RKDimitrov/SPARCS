...
# Usage
image_path = r".\MatchingImage.png"  # Your Stellarium image
...
# Save images
save_grayscale(img_pil, r".\grayscale_30fov_n2.png")
plot_detections(img, centroids, r".\debug_detected_stars_30fov__n2.png")
